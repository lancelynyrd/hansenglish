<table width="100%" align="center">
    ...
    <tr>
        <td width="100%" height="100px" background="<?php tde() ?>/img/class/back.jpg">
        </td>
    </tr>
</table>
    ...
    <tr>
        ...
        <td width="80%">
            ...
            <div class="exp-content-block"><h2 class="exp-content-head">skype账号怎么注册</h2><div class="content-list-text"><p></div>
                ...
                <div class="content-list-text"><p>1. 先<a href="http://skype.gmw.cn/" target="_blank">按这里</a>，打开如图在右上角找到注册</p></div>
                <div><img src="<?php tde() ?>/img/skype/reg_1.jpg" ></div></div>
            ...
            <div class="content-list-text"><p>4. 验证码这里要看清楚了，我第一次还填错了，个人觉得验证码还很有个性，如图是两个图，
                    <br>
                    &nbsp; &nbsp; &nbsp;要把两个图里的数字按顺序填写，有一张图不是纯数字的，比较容易弄错，可以刷新换相对清晰的图，
                    <br>
                    &nbsp; &nbsp; &nbsp;还有上面是否要通知，我都取消了(邮箱各种邮件看不过来)，填好点击同意提交</p></div>
            <div class="content-list-media"><img src="<?php tde() ?>/img/skype/reg_4.jpg" width="30%" ></div>

            <br><br><br><br>
            <div class="content-list-text"><p>5. 提交后稍等会，注册成功就会跳到首页，在右上角可以看到自己的账号名字了如图，用这个账号即可登录skype</p></div>
            <div class="content-list-media"><img src="<?php tde() ?>/img/skype/reg_5.jpg" width="30%"></div>

            <br><br><br><br>
            <div class="content-list-text"><p>6. 如图我用刚注册账号登录的skype界面</p></div>
            <div class="content-list-media"><img src="<?php tde() ?>/img/skype/reg_6.jpg" width="30%">
            </div>
            ...
            <div class="exp-content-block"><h2 class="exp-content-head"><a href="javascript:;" name="section-4"></a>skype怎么用microsoft账号登录</h2><div class="exp-content-body">
                    ...
                    <div class="content-list-media"><img src="<?php tde() ?>/img/skype/reg_2_1.jpg" width="30%">
                    </div>

                    <br><br><br><br>
                    <div class="content-list-text"><p>2. 进入如图界面，要先登录microsoft账号</p></div>
                    <div class="content-list-media"><img src="<?php tde() ?>/img/skype/reg_2_2.jpg" width="30%">
                    </div>
