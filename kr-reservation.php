        ...
        <div>
            ...
            <?php if ( is_user_logged_in() ) : ?>
                <nav>
                    ...
                    <div class="calendar-view btm-btn"><a href="<?php hd()?>kr-reservation<?php if( isset( $MnY ) ) echo '?'.$MnY; ?>"><?php _text('CALENDAR VIEW')?></a></div>
                    <div class="divider btm-btn"> | </div>
                    <span class="dashicons dashicons-list-view btm-btn"></span>
                    <div class="list-view btm-btn"><a href="<?php hd()?>kr-reservation?view=list<?php if( isset( $MnY ) ) echo '&'.$MnY; ?>"><?php _text('LIST VIEW')?></a></div>
                </nav>
            <?php endif; ?>
        </div>
    </section>
