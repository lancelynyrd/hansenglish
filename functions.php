...
add_action( 'wp_enqueue_scripts', function () {
    ...
    }elseif (strpos( seg(0), 'm-ch-home') !== false || strpos( seg(0), 'kr-m-') !== false ) {
    ...
    if ( is_front_page() || seg(0) == 'reservation' || seg(0) == 'enrollment' || seg(0) == 'user-log-in' || seg(0) == 'user-register' || seg(0) == 'm-ch-user-log-in'
        || seg(0) == 'm-ch-user-register' || seg(0) == 'm-ch-reservation' || seg(0) == 'testing' || seg(0) == 'kr-m-reservation' || seg(0) == 'kr-reservation'
        || seg(0) == 'kr-user-log-in' || seg(0) == 'kr-m-user-log-in' || seg(0) == 'kr-m-user-register' || seg(0) == 'kr-m-user-update' || seg(0) == 'm-ch-user-update' ) {
...
abc()->registerRoute(
    [
        'home', 'kr-home', 'ha-home', 'm-ch-home', 'kr-m-home',
...
function vc_url( $roomname = 'VC TEST Room' ) {
    ...
    $url = "https://english.withcenter.com/room/$username/$roomname";
    echo $url;
}
